...
\opening{Sehr geehrtes SAP Analytics Cloud Team,}

mit großem Interesse bewerbe ich mich auf die Position als Working Student (f/m/d) im SAP Analytics Cloud Development Team. Die Möglichkeit, an der Entwicklung von Enterprise-Grade Data Analytics Lösungen mitzuwirken und dabei Proof of Concepts und Software-Komponenten zu entwickeln, motiviert mich außerordentlich.
...
Meine technischen Kompetenzen umfassen fundierte Programmierkenntnisse in JavaScript und TypeScript, die ich sowohl in meinem DFKI-Projekt als auch in meiner Forschungsarbeit "COVID-19 personal protective equipment detection using real-time deep learning methods" (arXiv:2103.14878) eingesetzt habe. In dieser Arbeit habe ich mit YOLO und SSD MobileNet-Algorithmen gearbeitet und eine Genauigkeit von 90.6\% erreicht. Diese Erfahrung mit Datenverarbeitung und Analytics ist besonders relevant für Ihre SAP Analytics Cloud Entwicklung.

Ich verfüge über umfassende Erfahrung mit Datenbanken und Datenmodellierung, die ich sowohl in meinem DFKI-Projekt als auch in meiner Berufserfahrung bei Neocosmo eingesetzt habe. In meinem Circular Economy Seminar habe ich über 30 wissenschaftliche Paper analysiert und strukturiert aufbereitet, was meine Fähigkeiten in der Datenanalyse und Dokumentation unterstreicht.

Die Aufgaben dieser Position begeistern mich sehr, insbesondere die Möglichkeit, Proof of Concepts zu entwickeln, Software-Komponenten zu entwerfen und an Analytics-Features mitzuarbeiten. Die Arbeit im SAP Analytics Cloud Team bietet eine einzigartige Gelegenheit, an der Schnittstelle zwischen Datenanalyse und Enterprise-Software zu arbeiten und einen Beitrag zur Verbesserung von Business Intelligence zu leisten.

Meine Deutschkenntnisse sind sehr gut (C1), und ich verfüge über fließende Englischkenntnisse (C2). Ich bin bereit, vor Ort am SAP Walldorf Campus zu arbeiten und bringe hohe Motivation, Selbstständigkeit und Teamgeist mit.
